...
def drawScoreboard(hostScore, guestScore):  # todo: fix text position
    hostScore = impact25.render("Host:  " + str(hostScore), 1, WHITE)
    guestScore = impact25.render("Guest:  " + str(guestScore), 1, WHITE)

    display.blit(scoreBoard, (200,0))
    display.blit(guestScore, (width/4+25, 10))
    display.blit(hostScore, (width/4*2.5, 10))
...
pygame.display.set_caption("Despongcito 3: In Space (Deluxe Edition) (Collector's Edition) V.0.16")
