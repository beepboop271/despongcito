...
def drawTitle():
    ...
    settingsButton = drawCenteredButton(width/2, height/2+70, "Settings", arial, BLACK, WHITE, 10)
    quitButton = drawCenteredButton(width/2, height/2+140, "Quit!", arial, BLACK, WHITE, 10)
...
##    display.blit(gameBackground, (0,0))
    ...
    pygame.draw.rect(display, WHITE, (15, guestY, paddleLength/4, paddleLength))
    pygame.draw.rect(display, WHITE, (width-15-paddleLength/4, hostY, paddleLength/4, paddleLength))
    pygame.draw.ellipse(display, WHITE, (ballX-ballRadius, ballY-ballRadius, 2*ballRadius, 2*ballRadius)) #shift everything so the x,y references the centerdef drawPause():
    display.blit(pauseBackground, (0,0))
    pauseTitle = impact.render("PAUSED", 1, BLACK)
    display.blit(pauseTitle, (width / 2.75, 30))
    
    titleButton = drawCenteredButton(width/2, height/2-20, "Title Screen", arial, BLACK, WHITE, 10)
    settingsButton = drawCenteredButton(width/2, height/2+50, "Settings", arial, BLACK, WHITE, 10)
    quitButton = drawCenteredButton(width/2, height/2+120, "Quit!", arial, BLACK, WHITE, 10)
